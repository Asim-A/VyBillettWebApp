...
function setup_modal_delete_ajax() {
    ...
    $("a[data-modal_delete=true]").click(() => {
        ...
        $('#modal_delete_data_detail').html("AHAAHAHHAHA");
        ...
        //        data: { id: modal_data_id },  // en parameter inn i slett(id)-metoden i kunde-kontrolleren (JSON-objekt)
        //        success: function () {
